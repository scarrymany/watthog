...
# Пороги в ваттах от розетки для словесной оценки уровня потребления.
CONSUMPTION_TIERS = (
    (60.0, "Экономный", "green"),
    (150.0, "Умеренный", "cyan"),
    (300.0, "Заметный", "yellow"),
    (500.0, "Прожорливый", "orange3"),
    (float("inf"), "Ненасытный", "red"),
)
