...
| 💵 **Тарифы под рукой** | Готовые цены для Украины и России с датами вступления в силу, гривны и рубли переключаются одним выбором |
...
| `--preset КЛЮЧ` | Тариф из справочника: `ua`, `ua-night`, `ru-msk-gas`, `ru-msk-electric` |
...
По умолчанию считается по украинскому тарифу - **4.32 ₴ за кВт·ч**. Это единая по всей
стране цена для населения, установленная постановлением КМУ №632 от 31.05.2024.

Переключить на рубли можно одним выбором: в окне это выпадающий список «Тариф из
справочника», в консоли - пункт меню **5** или команда `watthog tariffs`.
...
настройках, валюта тоже: там обычное текстовое поле, а не список из двух вариантов.
